...
def main():
    ...
    assert url.host=='modish_styling_test_pg' and url.database=='modish_test', 'isolated_database_required'
    ...
    with TestClient(app,raise_server_exceptions=True) as client:
        ...
        for gender in ['menswear','womenswear']:
            ...
            for page in range(4):
                ...
                with SessionLocal() as db:
                    for item in feed:
                        ...
                        assert product_is_adult(model),f'child:{p["id"]}'
                ...
                with SessionLocal() as db:
                    ...
                    for p in related:
                        ...
                        assert product_is_adult(other) and p['gender_target'] in (gender,'unisex')
            ...
            assert req('GET','/feed',headers=headers)
