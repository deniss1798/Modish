...
REMOTE='/opt/modish-releases/20260916-release7'
...
with sock,sock.makefile('r',encoding='utf-8') as incoming:
 ...
 try:
  ...
  uploads=[(Path(os.environ['TEMP'])/'modish-release7.tar','source.tar'),
    (ROOT/'scripts/prepare_release7_remote.py','prepare.py'),(ROOT/'scripts/smoke_release7.py','smoke_release7.py')]
