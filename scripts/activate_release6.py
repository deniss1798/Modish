...
B=Path('/var/backups/modish/20260915-release6')
OLD='modish-backend:styling-fixes-20260913'
NEW='modish-backend:release6-20260915'
...
def main():
    ...
    unit=(R/'unit-tests.log').read_text();assert 'Ran 100 tests' in unit and '\nOK\n' in unit
    old=inspect('modish_backend');assert old['Config']['Image']==OLD
    assert old['Image']=='sha256:616e3501ca18e6ff309ed5a9d8dc1b096b2e52389ba770854da1e23c97acddf1'
    ...
    try:
        ...
        # The new session table is additive; old API remains compatible for rollback.
        ...
        record.update(status='deployed',image_id=inspect('modish_backend')['Image'],unit_tests=100,
        ...
        Path('/opt/Modish/DEPLOYMENT_CURRENT.md').write_text('# Current release\n\n'+str(R)+'\n\nImage: '+NEW+
            ...
            '\nRollback: '+str(R/'rollback.sh')+'\nAdded auth_sessions table; no catalog repairs in this release.\n'+
