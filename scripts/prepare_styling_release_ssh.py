...
with sock,sock.makefile('r',encoding='utf-8') as incoming:
 ...
 try:
  ...
  uploads=[(Path(os.environ['TEMP'])/'modish-styling-fixes.tar','source.tar'),
    (ROOT/'scripts/prepare_styling_release_remote.py','prepare.py'),(ROOT/'scripts/smoke_styling_fixes.py','smoke_styling_fixes.py')]
