...
Актуальная работа по руководству 2.3: [состояние и проверки](docs/modish2/current_state.md), [реестр замечаний](docs/modish2/issues.md). Эти статусы отделяют локальный код от публикации и действующего сервера.
